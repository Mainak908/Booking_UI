      ...
      <div className={type === "list" ? "" : "w-full flex flex-col gap-10"}>
        ...
        {type !== "list" && (
          <div className="">
            ...
            <div className=" h-12 bg-white border-2 border-yellow-200 flex items-center justify-between py-2 px-2 rounded-lg  w-screen max-w-screen-md absolute lg:left-1/4 sm:visible invisible">
              <div className="">
